...
class HiFiArk(torch.nn.Module):
    ...
    def forward(self, candidate_news, clicked_news):
        ...
        # batch_size, 1 + K, num_filters
        # print('user_archive_vector:',user_archive_vector.shape)
        ...
        # print(candidate_news_vector.view(size[0] * size[1], size[2]).shape)
        # print(user_vector.shape)
        # print(user_vector.view(size[0] * size[1],
        #                  size[2]).shape)
    ...
    def get_prediction(self, candidate_news_vector, user_archive_vector):
        ...
        """
        # 1, num_filters
        candidate_news_vector = candidate_news_vector.unsqueeze(dim=0)
        user_archive_vector = user_archive_vector.unsqueeze(dim=0)
        # print('candidate_news_vector',candidate_news_vector.shape)
        # print('user_archive_vector',user_archive_vector.shape)

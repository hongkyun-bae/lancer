...
class BaseConfig():
    ...
    # training_type = f'_impre{negative_sampling_ratio}'  #_impre #_recent
    ...
    num_batches_show_loss = 10000  # Number of batchs to show loss
    # Number of batchs to check metrics on validation dataset
    # num_batches_validate = 44653
    batch_size = 50
    ...
    num_users = 1 + 189633
    num_categories = 1 + 303
    num_words = 1 + 115781
    num_entities = 1 + 26150
